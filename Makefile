...
LIB = src/gt.o src/switch_x86_64.o
LIB_UCTX = src/gt_uctx.o

BINS = bin/demo bin/preempt_demo bin/io_test bin/echo_server \
       bin/switch_bench bin/switch_bench_uctx
